<template>
  <div id="slider">
    ...
    <div
      ...
      ref="container"
    >
      <img class="slider-img" v-for="(img,index) in imgs" :key="index" :src="img.url" alt="img.index">
    </div>
    <!-- index -->
...
<script>
  export default {
    ...
    data () {
      ...
      return{
        imgs:[
          {url: 'http://temporary.xindianmao.com/images/banner_01.jpg', index: 0},
          {url: 'http://temporary.xindianmao.com/images/banner_02.jpg', index: 1},
          {url: 'http://temporary.xindianmao.com/images/banner_01.jpg', index: 2},
          {url: 'http://temporary.xindianmao.com/images/banner_02.jpg', index: 3}],
        currentIndex: 0,
        buttons: [0,1,2,3],
        timer: null
      }
